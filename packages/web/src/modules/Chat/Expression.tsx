...
function Expression(props: ExpressionProps) {
        ...
        if (keywords) {
            ...
            if (result) {
                if (result.length !== 0) {
                    ...
                    Message.info('No related expressions found, try a different keyword');
                }
            }
        ...
        <div className={Style.defaultExpression}>
            {expressions.default.map((e) => (
                <div
                    ...
                    role="button"
                >
                    <div className={Style.defaultExpressionItem}>
                        {e}
                    </div>
                </div>
            ))}
    ...
    return (
        <div className={Style.expression}>
            ...
            >
                <TabPane tab="Default Expressions" key="default">
                    {renderDefaultExpression}
                </TabPane>
                <TabPane tab="Search Expression Packs" key="search">
