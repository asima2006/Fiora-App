...
function CodeEditor(props: CodeEditorProps) {
    ...
    useEffect(() => {
        (async () => {
            // Dynamically load language packages
            if (visible && !loadedLanguage[language]) {
                /**
                 * To reduce bundle size, language packages are imported individually here
                 * If variable paths are used directly, all files in that directory will be bundled
                 * Also, not importing individually makes it difficult to set webpackChunkName
                 */
                switch (language) {
                    case 'javascript': {
                        // @ts-ignore
                    ...
                    default: {
                        console.warn('Unsupported language package', language);
                    }
                }
