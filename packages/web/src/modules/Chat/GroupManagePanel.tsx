...
function GroupManagePanel(props: GroupManagePanelProps) {
    ...
    async function handleChangeGroupAvatar() {
        ...
        if (image.length > config.maxAvatarSize) {
            ...
            return Message.error('Failed to set group avatar, please select an image smaller than 1.5MB');
        }
        ...
        try {
            ...
            if (isSuccess) {
                ...
                Message.success('Group avatar changed successfully');
            }
        } catch (err) {
            console.error(err);
                ...
                <div className={Style.content}>
                    {isLogin && selfId === creator ? (
                        <div className={Style.block}>
                            <p className={Style.blockTitle}>Change Group Name</p>
                            <Input
