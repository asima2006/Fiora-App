...
/**
 * There are some issues with implementing Message component using hooks
 * Functionally, Message component needs to trigger scrolling after rendering, but in practice, triggering scrolling in useEffect is later than in componentDidMount
 * The specific manifestation is that you will first see historical messages, then flash and scroll to the appropriate position
 */
@pureRender
                        ...
                        {showButtonList && (
                            <div className={Style.buttonList}>
                                <Tooltip
                                    ...
                                    mouseEnterDelay={0.3}
                                    overlay={<span>Recall message</span>}
                                >
                                    <div>
                                        <IconButton
