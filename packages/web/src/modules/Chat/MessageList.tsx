...
function MessageList() {
    ...
    // Safety check: if linkman doesn't exist or messages is undefined, return empty div
    if (!linkman || !linkman.messages) {
        return <div className={styles.container} />;
    }
    
    const { type: linkmanType, creator, messages, unread } = linkman;
    const isGroup = linkmanType === 'group';
