                ...
                <TabPane tab="Function" key="function">
                    ...
                    >
                        <div className={Common.block}>
                            <p className={Common.title}>Theme</p>
                            <ThemeToggle />
                        </div>
                        <div className={Common.block}>
                            <p className={Common.title}>Switches</p>
                            <div className={Style.switchContainer}>
                                <div className={Style.switch}>
                                    <p className={Style.switchText}>Sound Notification</p>
                                    <Switch
                                        onChange={(value) =>
                                            action.setStatus(
                                                'soundSwitch',
                                ...
                                <div className={Style.switch}>
                                    <p className={Style.switchText}>Desktop Notification</p>
                                    <Switch
                                        onChange={(value) =>
                                            action.setStatus(
                                                'notificationSwitch',
                                ...
                                <div className={Style.switch}>
                                    <p className={Style.switchText}>
                                        Recommend Expressions Based on Input
                                    </p>
                                    <Switch
                                        onChange={(value) =>
                                            action.setStatus(
                ...
                <TabPane tab="Theme" key="theme">
                    ...
                    >
                        ...
                        {theme === 'custom' && (
                            <>
                                <div className={Common.block}>
                                    <p className={Common.title}>Aero Effect</p>
                                    <div>
                                        <Switch
                                            onChange={(value) =>
                                ...
                                <div className={Common.block}>
                                    <p className={Common.title}>
                                        ...
                                        <span className={Style.backgroundTip}>
                                            Background image will be stretched to browser window size,
                                            reasonable proportions will achieve better results
                                        </span>
                                    </p>
                                    <div
                                        className={
