...
function SelfInfo(props: SelfInfoProps) {
    ...
    //         return Message.error('Failed to set avatar, please select an image smaller than 1.5MB');
    //     }

    //     // gif avatar doesn't need cropping
    //     if (file.ext === 'gif') {
    //         uploadAvatar(file.result as Blob, file.ext);
    //     } else {
    //         // Show avatar cropping
    ...
    async function handleChangeUsername() {
        ...
        if (isSuccess) {
            onClose();
            reLogin('Username changed successfully, please login again with new username');
        }
    }

    function handleCloseDialog(event: any) {
        /**
         * Click close button or click mask to close dialog
         */
        ...
        >
            <div className={Common.container}>
                {/* <div className={Common.block}>
                    <p className={Common.title}>Change Avatar</p>
