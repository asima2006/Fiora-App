...
import { ActionTypes, Community, Channel } from '../state/action';
...
export default function useAction() {
    ...
    return {
        ...
        setCommunities(communities: Community[]) {
            dispatch({
                type: ActionTypes.SetCommunities,
                payload: communities,
            });
        },
        ...
        removeCommunity(communityId: string) {
            dispatch({
                type: ActionTypes.RemoveCommunity,
                payload: communityId,
            });
        },

        updateCommunity(communityId: string, data: Partial<Community>) {
            dispatch({
                type: ActionTypes.UpdateCommunity,
                payload: {
                    communityId,
                    data,
                },
        ...
        removeChannel(channelId: string) {
            dispatch({
                type: ActionTypes.RemoveChannel,
                payload: channelId,
            });
        },
        ...
        updateChannel(channelId: string, data: Partial<Channel>) {
            dispatch({
                type: ActionTypes.UpdateChannel,
                payload: {
                    channelId,
                    data,
                },
