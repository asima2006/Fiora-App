...
6. Choose the theme you like, and you can set it as any wallpaper and theme color you like, including a **new dark sidebar theme** with compact layout
7. Set up an administrator to manage users
8. **Dark Sidebar Theme**: Modern compact dark UI with collapsible sidebar, profile menu, and high-contrast design (See [DARK_THEME_GUIDE.md](./DARK_THEME_GUIDE.md))
